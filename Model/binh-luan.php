...
function binh_luan_select_all_name()
{
    $sql = "SELECT binhluan.id, binhluan.noidung, binhluan.id_user, binhluan.id_phim, binhluan.timebl, users.ten_user FROM binhluan JOIN users ON users.id = binhluan.id_user";
    return pdo_query($sql);
}
...
=======
    $sql = "SELECT binhluan.noidung, binhluan.timebl ,phim.id  FROM binhluan INNER JOIN phim ON phim.id = binhluan.id_phim where binhluan.id_phim = '$id_phim'";
>>>>>>> 47cff3d6850127dc184c3e1b204c6cd572ed928e
    return pdo_query($sql);
}
