<section class="tong_chinh_sach">
    <div class="menu_chinh_sach">
        <h6 onclick="the_le()" class="nut_thele" style="color: white; border-radius: 10px; background-color: #034EA2;">Thể Hiện</h6>
        <h6 onclick="quyen_loi()" class="nut_quyenloi">Quyền Lợi</h6>
        <h6 onclick="huong_dan()" class="nut_huongdan">Hướng Dẫn</h6>
    </div>
    <div class="chinh_main">
        <div class="the_le">
            <h5>Thể Lệ</h5>
            <div class="text1_tl">
            ...
            <img src="./IMG/the_le1.png" alt="" height="">
            <div class="text2_tl">
            ...
            <div class="text4_tl">
                ...
                <div class="text4_tl_nho">
                    ...
                    <li><span>Số điện thoại không hợp lệ</span> là số điện thoại không liên lạc được hoặc số điện thoại không thuộc sở hữu của chủ tài khoản thành viên ở thời điểm Galaxy Cinema rà soát dữ liệu thành viên.</>
                    </li>
